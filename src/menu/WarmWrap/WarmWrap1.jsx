            ...
            <div className={styles.content}>
                ...
                <div className={styles.sandWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/warmWrap1">우삼겹 웜랩</Link></li>
                ...
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>우삼겹 웜랩</h3>
                        <p>또띠아 속 단짠단짠 우삼겹과 고소한 곡물밥으로 든든하게!</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/warmWrap" className={styles.prev}>prev</Link>
                            <Link to="/warmWrap2" className={styles.next}>next</Link>
                        </div>
                        <div className={styles.view__cont}>
                            <div className={styles.left__img}>
                                <img src="/images/menu30.png" alt="" />
