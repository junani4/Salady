            ...
            <div className={styles.content}>
                ...
                <div className={styles.sandWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/sand3">크리미연어 샌드</Link></li>
                    </ul>
                </div>
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>크리미연어 샌드</h3>
                        <p>귀리번 속 매콤알싸한 크리미할라피뇨 드레싱과 연어의 만남</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/sand2" className={styles.prev}>prev</Link>
                            <Link to="/wrap" className={styles.next}>next</Link>
                        </div>
