            ...
            <div className={styles.content}>
                ...
                <div className={styles.saladWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/salad2">우삼겹메밀면 샐러디</Link></li>
                ...
                <div className={styles.view}>
                    ...
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/salad1" className={styles.prev}>prev</Link>
                            <Link to="/salad3" className={styles.next}>next</Link>
                        </div>
