            ...
            <div className={styles.content}>
                ...
                <div className={styles.lnbWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/bowl1">우삼겹 웜볼</Link></li>
                ...
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>우삼겹 웜볼</h3>
                        <p>풍미가득한 우삼겹과 고소한 견과류,오리엔탈 드레싱 조합</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/bowl" className={styles.prev}>prev</Link>
                            <Link to="/bowl2" className={styles.next}>next</Link>
                        </div>
