            ...
            <div className={styles.content}>
                ...
                <div className={styles.saladWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/salad5">탄단지 샐러디</Link></li>
                ...
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>탄단지 샐러디</h3>
                        <p>탄수화물, 단백질, 지방을 골고루 채운 샐러디 스테디 메뉴</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/salad4" className={styles.prev}>prev</Link>
                            <Link to="/salad6" className={styles.next}>next</Link>
                        </div>
