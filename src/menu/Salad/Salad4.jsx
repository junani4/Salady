            ...
            <div className={styles.content}>
                ...
                <div className={styles.saladWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/salad4">콥 샐러디</Link></li>
                ...
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>콥 샐러디</h3>
                        <p>옥수수, 베이컨, 올리브 등 다채로운 재료에 시저의 고소함까지!</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/salad3" className={styles.prev}>prev</Link>
                            <Link to="/salad5" className={styles.next}>next</Link>
                        </div>
