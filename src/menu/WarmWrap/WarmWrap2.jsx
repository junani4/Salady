            ...
            <div className={styles.content}>
                ...
                <div className={styles.sandWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/warmWrap2">팔라펠 웜랩</Link></li>
                ...
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>팔라펠 웜랩</h3>
                        <p>또띠아 속 고소한 팔라펠과 든든한 곡물밥의 균형잡힌 맛</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/warmWrap1" className={styles.prev}>prev</Link>
                            <Link to="/warmWrap3" className={styles.next}>next</Link>
                        </div>
                        <div className={styles.view__cont}>
                            <div className={styles.left__img}>
                                <img src="/images/menu31.jpg" alt="" />
