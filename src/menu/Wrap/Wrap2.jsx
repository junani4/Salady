        ...
        <div id="wrap">
            ...
            <div className={styles.content}>
                ...
                <div className={styles.sandWrap3}>
                    <ul>
                        <li><Link to="/wrap">멕시칸 랩</Link></li>
                        <li><Link to="/wrap1">시저치킨 랩</Link></li>
                        <li className={styles.li__bg}><Link to="/wrap2">크랜베리그릭 랩</Link></li>
                ...
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>크랜베리그릭 랩</h3>
                        <p>또띠아 속 상큼고소함 가득! 중독성있는 맛</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/wrap1" className={styles.prev}>prev</Link>
                            <Link to="/wrap3" className={styles.next}>next</Link>
                        </div>
                        <div className={styles.view__cont}>
                            <div className={styles.left__img}>
                                <img src="/images/menu27.png" alt="" />
