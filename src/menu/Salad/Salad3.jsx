            ...
            <div className={styles.content}>
                ...
                <div className={styles.saladWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/salad3">리코타치즈 샐러디</Link></li>
                ...
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>리코타치즈 샐러디</h3>
                        <p>꾸덕한 리코타치즈와 통밀빵까지! 완벽한 브런치 스타일</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/salad2" className={styles.prev}>prev</Link>
                            <Link to="/salad4" className={styles.next}>next</Link>
                        </div>
