            ...
            <div className={styles.content}>
                ...
                <div className={styles.sandWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/wrap3">크리미연어 랩</Link></li>
                    </ul>
                </div>
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>크리미연어 랩</h3>
                        <p>또띠아 속 알싸한 크리미할라피뇨 드레싱과 신선한 연어와의 만남</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/wrap2" className={styles.prev}>prev</Link>
                            <Link to="/warmWrap" className={styles.next}>next</Link>
                        </div>
                        <div className={styles.view__cont}>
                            <div className={styles.left__img}>
                                <img src="/images/menu28.png" alt="" />
