        ...
        <div id="salad">
            ...
            <div className={styles.content}>
                ...
                <div className={styles.saladWrap3}>
                    <ul>
                        <li><Link to="/salad">콜드컷그래놀라 샐러디</Link></li>
                        <li className={styles.li__bg}><Link to="/salad1">연어 샐러디</Link></li>
                ...
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>연어 샐러디</h3>
                        <p>신선한 연어와 달콤한 스윗포테이토의 달콤고소한 조합</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/salad" className={styles.prev}>prev</Link>
                            <Link to="/salad2" className={styles.next}>next</Link>
                        </div>
                        <div className={styles.view__cont}>
                            <div className={styles.left__img}>
                                <img src="/images/menu19.jpg" alt="" />
