            ...
            <div className={styles.content}>
                ...
                <div className={styles.saladWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/salad6">시저치킨 샐러디</Link></li>
                    </ul>
                </div>
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>시저치킨 샐러디</h3>
                        <p>치킨과 크랜베리, 시저의 담백하고 클래식한 맛</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/salad5" className={styles.prev}>prev</Link>
                        </div>
                        <div className={styles.view__cont}>
                            <div className={styles.left__img}>
                                <img src="/images/menu15.jpg" alt="" />
