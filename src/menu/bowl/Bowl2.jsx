            ...
            <div className={styles.content}>
                ...
                <div className={styles.lnbWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/bowl2">팔라펠단호박 웜볼</Link></li>
                ...
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>팔라펠단호박 웜볼</h3>
                        <p>겉은 바삭, 속은 촉촉한 순식물성 크로켓의 고소함이 가득!</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/bowl1" className={styles.prev}>prev</Link>
                            <Link to="/bowl3" className={styles.next}>next</Link>
                        </div>
