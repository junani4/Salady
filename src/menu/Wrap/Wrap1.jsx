            ...
            <div className={styles.content}>
                ...
                <div className={styles.sandWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/wrap1">시저치킨 랩</Link></li>
                ...
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>시저치킨 랩</h3>
                        <p>또띠아 속 닭가슴살의 담백함과 크랜베리의 상큼함의 조화</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/wrap" className={styles.prev}>prev</Link>
                            <Link to="/wrap2" className={styles.next}>next</Link>
                        </div>
                        <div className={styles.view__cont}>
                            <div className={styles.left__img}>
                                <img src="/images/menu26.png" alt="" />
