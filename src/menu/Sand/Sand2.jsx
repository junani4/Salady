            ...
            <div className={styles.content}>
                ...
                <div className={styles.sandWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/sand2">에그베이컨 샌드</Link></li>
                ...
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>에그베이컨 샌드</h3>
                        <p>귀리번 속 담백한 계란과 짭쪼름한 베이컨의 꿀조합</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/sand1" className={styles.prev}>prev</Link>
                            <Link to="/sand3" className={styles.next}>next</Link>
                        </div>
