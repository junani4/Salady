            ...
            <div className={styles.content}>
                ...
                <div className={styles.lnbWrap3}>
                    <ul>
                        ...
                        <li className={styles.li__bg}><Link to="/bowl4">할라피뇨치킨 웜볼</Link></li>
                    </ul>
                </div>
                <div className={styles.view}>
                    <div className={styles.view__tit}>
                        <h3>할라피뇨치킨 웜볼</h3>
                        <p>담백한 닭가슴살과 알싸한 할라피뇨가 만나 이국적인 맛</p>
                    </div>
                    <div className={styles.body}>
                        <div className={styles.view__arrow}>
                            <Link to="/bowl3" className={styles.prev}>prev</Link>
                        </div>
